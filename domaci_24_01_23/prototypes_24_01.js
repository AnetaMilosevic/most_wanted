...
Car.prototype.accelerate = function (givenNumb) {
    var acceleration = this.motion + givenNumb
    return acceleration
}
Car.prototype.break = function (givenNumb) {
...
tv.prototype.increaseVolume = function (givenValue) {
...
tv.prototype.decreaseVolume = function (givenValue) {
    this.volume = this.volume - givenValue
    if (this.volume < 0) {
        this.volume = 0;
...
tv.prototype.setChannel = function (givenNumb) {
...
tv.prototype.statusInfo = function () {
